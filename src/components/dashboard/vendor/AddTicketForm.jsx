    ...
    <>
      ...
      <div className="max-w-lg text-center border border-red-300 rounded-xl p-8 bg-red-500/20">
        ...
        <p className="mt-2  text-red-600">
          You cannot add new tickets. Please contact the administrator if you
                  ...
                  <div className="bg-blue-500/5 dark:bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 flex items-start gap-3 mb-4 text-left">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-on-surface-variant leading-relaxed">
                        This ticket will be reviewed by an admin before going
                        live in the marketplace. Usually takes 2-4 hours.
                      </p>
                    </div>
